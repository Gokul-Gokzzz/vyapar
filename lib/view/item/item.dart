...
import 'package:vyapar/view/item/add_item.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildQuickLinkItem(
                            'assets/onlinestore.jpeg', 'Online Store'),
                        _buildQuickLinkItem(
                            'assets/stock.jpeg', 'Stock Summary'),
                        _buildQuickLinkItem(
                            'assets/item.jpeg', 'Item Settings'),
                        GestureDetector(
                          onTap: () {
                            _showAllOptions(context);
                          },
                          child: _buildQuickLinkItem(
                              'assets/show all.jpeg', 'Show All'),
                        ),
                      ],
                    ),
                  ],
            ...
            children: [
              ...
              Expanded(
                child: GridView.count(
                  ...
                  children: [
                    _buildQuickLinkItem(
                        'assets/import items.jpeg', 'Import Items'),
                    _buildQuickLinkItem(
                        'assets/export items.jpeg', 'Export Items'),
                    _buildQuickLinkItem(
                        'assets/item wise pnl.jpeg', 'Item wise PnL'),
                    _buildQuickLinkItem(
                        'assets/additional field.jpeg', 'Additional Fields'),
                    _buildQuickLinkItem(
                        'assets/item details.jpeg', 'Item Details'),
                    _buildQuickLinkItem(
                        'assets/low stock.jpeg', 'Low Stock Sum...'),
                  ],
                ),
              ),
            ],
