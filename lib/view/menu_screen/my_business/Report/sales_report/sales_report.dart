          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Filters Applied:', style: TextStyle(fontSize: 12)),
                  OutlinedButton.icon(
                    icon: Icon(Icons.filter_alt, size: 16),
                    label: Text('Filters', style: TextStyle(fontSize: 12)),
                    onPressed: () {},
        ...
        child: Row(
          ...
          children: [
                ...
                Row(
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(label1 + ': ', style: TextStyle(fontSize: 12)),
            ...
            Column(
              ...
              children: [
                Text(txnType, style: TextStyle(fontSize: 12)),
